...
```
(sur AUS, il est possible qu'il faille répéter cette opération plusieurs fois)
...
[Documentation détaillée de la fonction](http://xkfzv9.pages.innovation.insee.eu/fmtsas/reference/from_tab.html).
...
[Documentation détaillée de la fonction](http://xkfzv9.pages.innovation.insee.eu/fmtsas/reference/from_pgm.html).
<!-- lien en dur, trouver un moyen de rendre cela portable -->
...
- chaque élément est un objet de type `fmtsas_c`, ce qui permet d'utiliser
  l'[opérateur de sélection](http://xkfzv9.pages.innovation.insee.eu/fmtsas/reference/extract.fmtsas_c.html)
...
[Contribuez](https://git.stable.innovation.insee.eu/xkfzv9/fmtsas), notamment en
signalant des bugs ou des cas où le package ne fonctionne pas correctement (de
préference [ici](https://git.stable.innovation.insee.eu/xkfzv9/fmtsas/issues)).
